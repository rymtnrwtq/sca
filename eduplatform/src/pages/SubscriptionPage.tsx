    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-2xl mx-auto space-y-6 pb-28 md:pb-8">
      ...
      <div className="space-y-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center justify-center gap-2 py-4 bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white rounded-2xl font-bold transition-all"
        >
          <Crown size={18} className="text-orange-500" />
          Управление подпиской
          <ExternalLink size={15} className="opacity-50 ml-auto" />
        </a>
        ...
        <button
          onClick={copyRef}
          className="w-full flex items-center gap-2 py-4 px-5 bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white rounded-2xl font-bold transition-all"
        >
          <Users size={18} className="text-blue-400" />
          Реферальная ссылка
          <span className="ml-auto flex items-center gap-1.5 text-sm font-normal text-zinc-500">
